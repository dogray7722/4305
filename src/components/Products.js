    ...
    return (
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Language for Business</h5>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Language for School</h5>

            <p class="light">Rapidly improve your vocubulary, grammar, listening and pronunciation skills with Blabblerly for School.  With our patented AssureSmart technology we will find your current level with precision accuracy, and ease, and custom create a set of lessons based on the areas of your choice.  Ace the tests, and amaze your classmates and instructors!</p>
          </div>
        </div>

        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center light-blue-text"><i class="material-icons">flight_takeoff</i></h2>
            <h5 class="center">Language for Travel</h5>

            <p class="light">Are you traveling to a place where people speak a different language?  With Blabberly for Travel, you will be chatting with the locals in no time.  Blabberly uses the most relevant, up-to-date, and culturally specific conversational scenarios so you don't have to worry about learning vocabulary and phrases for a bygone era.  A little practice with our app will go a long, long way.  Bon voyage! </p>
          </div>
        </div>
      </div>
    </div>
